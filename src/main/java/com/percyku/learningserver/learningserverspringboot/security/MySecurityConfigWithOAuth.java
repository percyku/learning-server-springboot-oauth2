...
@Configuration
@EnableWebSecurity
public class MySecurityConfigWithOAuth {
    @Autowired
...
//                                .requestMatchers("/hello","/welcome","/welcome2","/loginforlearnsys","/logoutforlearnsys","/loginforlearnsyswithauth2","/updateProfile").authenticated()
                                .requestMatchers("/loginforlearnsys","/logoutforlearnsys","/loginforlearnsyswithauth2","updateProfile").authenticated()
